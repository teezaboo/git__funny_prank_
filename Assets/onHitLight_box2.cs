...
public class onHitLight_box2 : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.gameObject.CompareTag("tree"))
        {
            ...
            if(other.gameObject.GetComponent<tree_controller>().isDie != true){
                other.gameObject.GetComponent<tree_controller>()._isfire();
            }
        }
        if (other.gameObject.CompareTag("building"))
        {
            ...
            if(other.gameObject.GetComponent<build_controller>().isDie != true){
                other.gameObject.GetComponent<build_controller>()._isfire();
            }
        }
    }
}
